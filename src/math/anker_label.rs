...
impl AnkerLabel<'_> {
    pub fn new<'a>(x_: f64, y_: f64, z_: f64, text_: String, font_ : String, canvas_ : &Canvas<Window>) -> Self {
        let ttf_context = sdl2::ttf::init().map_err(|e| e.to_string()).unwrap();
        let mut font: sdl2::ttf::Font<'a, 'static> = ttf_context.load_font(font_, 16).unwrap();
...
impl Transformable for AnkerLabel<'_> {
